  ...
  for (unsigned shaderIdx = 0; shaderIdx < numPasses; ++shaderIdx)
  {
    ...
    switch (pass.fbo.scaleX.type)
    {
      ...
      case SCALE_TYPE_VIEWPORT:
        scaledSize.x = pass.fbo.scaleX.scale ? pass.fbo.scaleX.scale * m_outputSize.x : m_outputSize.x;
        break;
    ...
    switch (pass.fbo.scaleY.type)
    {
      case SCALE_TYPE_ABSOLUTE:
        ...
        break;
      case SCALE_TYPE_VIEWPORT:
        scaledSize.y = pass.fbo.scaleY.scale ? pass.fbo.scaleY.scale * m_outputSize.y : m_outputSize.y;
        break;
      case SCALE_TYPE_INPUT:
      default:
